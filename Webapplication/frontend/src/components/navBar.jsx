...
import carIcon from "../../src/Images/electric-car.png"
...
const NavBar = () => {
  ...
  return (
    ...
    >
      <img src={carIcon} style={{paddingLeft:'25px'}}/>
      <Link className="navbar-brand col-sm-3 col-md-2 mr-0" to="/" style={{paddingRight:'20px'}}>
        AVCloud
      </Link>
      <button
